...
plot(x = plot_data$Date_time, y = plot_data$Global_active_power, type = "l", xlab = "", ylab = "Global Active Power")

plot(x = plot_data$Date_time, y = plot_data$Voltage, type = "l", xlab = "datetime", ylab = "Voltage")
...
legend(x = "topright", legend = colnames(plot_data)[7:9], col = c("black", "red", "blue"), lty = 1, bty = "n")
